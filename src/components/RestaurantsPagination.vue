<template>
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <!-- 前一頁 prevPage -->
      <li :class="['page-item', { disabled: currentPage === 1 }]" v-show="prevPage">
      ...
      <li :class="['page-item', { disabled: currentPage === totalPage.length }]" v-show="nextPage">
        <router-link class="page-link" aria-label="Next" :to="{ name: 'restaurants', query: { page: nextPage, categoryId } }">
